...
(function () {
    ...
    style.textContent = `
        ...
        :root {
			...
			--gn:#b7d6a8; --gn2:rgba(183,214,168,.14);
			--bl:#a8c4d6; --bl2:rgba(168,196,214,.14);
			--wh:rgba(255,246,216,.08); --gy:#6b6598;
			--rd:#e0a0a0; --rd2:rgba(224,160,160,.16); --ye:#d6c496;
			--or:#d6b896; --or2:rgba(214,184,150,.14);
			--pk:#d6a8c4; --pk2:rgba(214,168,196,.14);
		}
