...
(function () {
    ...
    style.textContent = `
        ...
        :root {
			...
			--gn:#7ee787; --gn2:rgba(126,231,135,.06);
			--bl:#79c0ff; --bl2:rgba(121,192,255,.06);
			--wh:rgba(255,246,216,.08); --gy:#6b6598;
			--rd:#ff6b6b; --rd2:rgba(255,107,107,.06); --ye:#ffe082;
			--or:#ffb37e; --or2:rgba(255,179,126,.06);
			--pk:#ff9ecf; --pk2:rgba(255,158,207,.06);
		}
