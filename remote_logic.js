    ...
    function createNamingCard() {
        ...
        card.innerHTML = `
            ...
            <div style="display: flex; gap: 5px; margin-bottom: 10px;">
                ...
                <button id="copyFileName" style="background: #007bff; color: white; border: none; padding: 5px 10px; border-radius: 4px; cursor: pointer; font-weight: bold; font-size:15px; min-width: 90px; white-space: nowrap; flex-shrink: 0;">복사</button>
            </div>
                ...
                const patchItems = [
                    {
                        ...
                        date: '2026-05-27',
                        items: [
                            '다중 및 일일 업무는 시트 에러발생 시 기존 목록을 유지함',
                            '일일 업무는 시트가 정상일 때, 5분 마다 리프레쉬함',
