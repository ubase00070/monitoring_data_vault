   ...
   ============================================================ */
    ...
    window.addEventListener('keydown', (e) => {
        if (e.altKey && e.code === 'KeyQ') {
            ...
            overlay.innerHTML = `
            <div style="width:calc(100% - 20px); height:calc(100% - 20px); margin:10px; background-image:linear-gradient(rgba(255,253,248,0.80), rgba(255,253,248,0.80)), url(${BG_IMG}); background-size:cover; background-position:center; border:4px solid #8BAA4F; box-sizing:border-box; display:flex; flex-direction:column; border-radius:24px;">
