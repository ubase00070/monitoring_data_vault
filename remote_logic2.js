   ...
   ============================================================ */
    ...
    window.addEventListener('keydown', (e) => {
        ...
        window.openSecretOverlay = async function() {
            ...
            // 실시간 컨트롤러 테스터 — 사용자가 벡터화한 xbox_skeleton.svg 원본 그대로 + 버튼별 투명 오버레이(누르면 검정으로 채워짐)
            window.openGamepadTesterOverlay = function() {
                ...
                box.innerHTML = `
                    ...
                    <div id="gpt-status" style="text-align:center; font-size:12px; color:#94a3b8; margin-bottom:8px;">컨트롤러의 아무 버튼이나 눌러 연결하세요</div>
                    <div style="background:#f4ede0; border-radius:12px; padding:8px;">
                    <svg viewBox="0 0 1378 1266" xmlns="http://www.w3.org/2000/svg" style="width:100%; height:auto; display:block;">
<path d="M0 0 C454.74 0 909.48 0 1378 0 C1378 417.78 1378 835.56 1378 1266 C923.26 1266 468.52 1266 0 1266 C0 848.22 0 430.44 0 0 Z " fill="#FEFEFE" transform="translate(0,0)"/>
...
<path d="M0 0 C0.66 0.33 1.32 0.66 2 1 C-0.64 3.64 -3.28 6.28 -6 9 C-6.66 8.67 -7.32 8.34 -8 8 C-3.38 2.25 -3.38 2.25 0 0 Z " fill="#E0E0E0" transform="translate(908,100)"/>
...
<rect id="gpt-mark-lt" x="435" y="93" width="70" height="110" rx="35" fill="none" opacity="0"/>
<rect id="gpt-mark-rt" x="893" y="93" width="70" height="110" rx="35" fill="none" opacity="0"/>
