    ...
    function createNamingCard() {
        ...
        card.innerHTML = `
            ...
            <div style="display: flex; gap: 5px; margin-bottom: 10px;">
                ...
                <button id="copyFileName" style="background: #007bff; color: white; border: none; padding: 5px 8px; border-radius: 4px; cursor: pointer; font-weight: bold; font-size:14px;">복사</button>
            </div>
