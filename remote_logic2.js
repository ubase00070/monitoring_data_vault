(function() {
    ...
    function updateBatteryStatus() {
        ...
        header.style.cssText = "display:flex; justify-content:space-between; align-items:center; margin-bottom:15px; border-bottom:1px solid #334155; padding-bottom:10px;";
   ...
   ============================================================ */
    ...
    function createNamingCard() {
        ...
        card.style.cssText = 'background:#1e293b; padding:10px 15px; border-radius:15px; border:1px solid #334155; margin-top:5px;';
    ...
    function renderDashboard() {
        ...
        patchBtn.onclick = () => {
            ...
            if (!patchOverlay) {
                ...
                patchItems.forEach(patch => {
                    ...
                    section.style.cssText = "background:#1e293b; border:1px solid #334155; border-radius:12px; padding:14px 16px;";
        ...
        taskCard.style.cssText = "background:#1e293b; padding:15px; border-radius:15px; border:1px solid #334155;";
        ...
        mapCard.style.cssText = "background:#1e293b; padding:8px 12px; border-radius:15px; border:1px solid #334155; display:flex; justify-content:space-between; align-items:center;";
        ...
        queueCard.style.cssText = "background:#1e293b; padding:8px 12px; border-radius:15px; border:1px solid #334155; display:flex; justify-content:space-between; align-items:center;";
        ...
        scheduleCard.style.cssText = "background:#1e293b; padding:8px 12px; border-radius:15px; border:1px solid #334155; cursor:pointer; display:flex; align-items:center;";
        ...
        tipsCard.style.cssText = "background:#1e293b; padding:8px 12px; border-radius:15px; border:1px solid #334155; cursor:pointer; display:inline-flex; align-items:center;";
        ...
        batteryCard.style.cssText = "background:#1e293b; padding:8px 12px; border-radius:15px; border:1px solid #334155; display:flex; justify-content:space-between; align-items:center;";
    ...
    function createMenuCard(name, desc, stateKey, storageKey, action, btnLabel = '열기') {
        const card = document.createElement('div');
        card.style.cssText = "background:#1e293b; padding:15px; border-radius:15px; display:flex; justify-content:space-between; align-items:center; border:1px solid #334155;";
