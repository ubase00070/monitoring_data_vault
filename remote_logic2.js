(function() {
    ...
    (function loadPaperlogyFont() {
        ...
        link.rel = 'stylesheet';
        link.href = 'https://cdn.jsdelivr.net/gh/projectnoonnu/2408-3@1.0/Paperlogy.css';
        document.head.appendChild(link);
    })();

    // ── Paperlogy 전역 적용 (대시보드 + 배터리팝업 내부 전체) ──
    (function applyPaperlogy() {
        if (document.getElementById('neubie-paperlogy-style')) return;
        const st = document.createElement('style');
        st.id = 'neubie-paperlogy-style';
        st.textContent = `
