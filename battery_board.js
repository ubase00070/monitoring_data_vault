...
*/
    ...
    const NG_EXCLUDE_NAMES = ['배송띠띠', '순찰띠띠', '삼성인력개발원1호기', '318호기', '319호기', '두비', '달비', '인재개발원1호기', '김포풍무센트럴푸르지오1호기', '부천위브1호기', '잠실리센츠아파트1호기', '잠실리센츠아파트2호기', '잠실엘스아파트1호기', '잠실엘스아파트2호기', '김포캐슬앤파밀리에1호기', '김포캐슬앤파밀리에2호기', '부산서면비스타동원1호기', '아주대학교1호기', '아주대학교2호기', '지제역 푸르지오엘리아츠 1호기'];   // 이름으로 직접 제외 (공백 무시, 정확히 일치할 때만)
