...
(function () {
	...
	(function() {
		...
		if (isNaN(charIdx) || charIdx < 0 || charIdx >= WALKER_CHARACTERS.length) charIdx = 0;
		...
		function currentVariantFile() {
			const variants = WALKER_CHARACTERS[charIdx].variants;
		...
		walkerEl.addEventListener('click', () => {
			charIdx = (charIdx + 1) % WALKER_CHARACTERS.length;
