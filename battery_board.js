...
(function () {
        ...
        <div id="bb">
            ...
            <div id="bb-info-panel">
                ...
                <div id="bb-info-body">
                    ...
                    * 실수로 다른 페이지로 이동했다면 재접속 또는 새로고침 필요(그 시간동안 기록 누락이 발생하지만, 알림을 조금 늦게 받는 수준으로 추정)<br>
    ...
    const SITE_IDS = [
        2,22,24,25,27,36,37,40,42,44,45,46,47,48,50,53,56,57,62,64,
        65,66,72,75,82,86,100,105,108,109,111,115,117,118,126,131,
        132,134,135,137,138,140,141,142,143,144,145,146,150,151,173,
        174,177,178,179,180,181,182,187,193,196,202,203,214
    ];
